...
// Exact ANSI-colored output captured from running lde 0.10.0-nightly
const tabs: { id: string; label: string; lines: Line[] }[] = [
	{
		...
		lines: [
			...
			{ type: "blank" },
			{ type: "out", text: `${E}1mCommands:${E}0m` },
			{ type: "out", text: `  ${E}1m${E}32mhelp      ${E}0m  ${E}90m            ${E}0m Show help for a command` },
			{ type: "out", text: `  ${E}1m${E}32mrun       ${E}0m  ${E}90m            ${E}0m Execute a project` },
			{ type: "out", text: `  ${E}1m${E}32mx         ${E}0m  ${E}90m--git <url> ${E}0m Run a package from a git repo or path` },
			{ type: "out", text: `  ${E}1m${E}32mrepl      ${E}0m  ${E}90m            ${E}0m Start an interactive LuaJIT REPL` },
			{ type: "out", text: `  ${E}1m${E}32mtest      ${E}0m  ${E}90m            ${E}0m Run project tests` },
			{ type: "blank" },
			{ type: "out", text: `  ${E}1m${E}31mnew       ${E}0m  ${E}90mmyproject   ${E}0m Create a new project` },
			{ type: "out", text: `  ${E}1m${E}31minit      ${E}0m  ${E}90m            ${E}0m Initialize current directory as a project` },
			{ type: "out", text: `  ${E}1m${E}31mupgrade   ${E}0m  ${E}90m            ${E}0m Upgrade lde to the latest version` },
			{ type: "blank" },
			{ type: "out", text: `  ${E}1m${E}33msync      ${E}0m  ${E}90m            ${E}0m Install dependencies (--locked: from lockfile only)` },
			{ type: "out", text: `  ${E}1m${E}33minstall   ${E}0m  ${E}90mrocks:tl    ${E}0m Install a tool to PATH with --git/--path/rocks:` },
			{ type: "out", text: `  ${E}1m${E}33muninstall ${E}0m  ${E}90mtl          ${E}0m Uninstall a tool from PATH` },
			{ type: "out", text: `  ${E}1m${E}33madd       ${E}0m  ${E}90mhood        ${E}0m Add a dependency (--path <path> or --git <url>)` },
			{ type: "out", text: `  ${E}1m${E}33mremove    ${E}0m  ${E}90mjson        ${E}0m Remove a dependency` },
			{ type: "out", text: `  ${E}1m${E}33mtree      ${E}0m  ${E}90m            ${E}0m Show the dependency tree` },
			...
			{ type: "blank" },
			{ type: "out", text: `  ${E}1m${E}36mcompletion${E}0m  ${E}90mbash        ${E}0m Print a shell completion script (bash|zsh|fish)` },
			{ type: "out", text: `  ${E}1m${E}90m<command> ${E}0m  ${E}36m--help      ${E}0m Print help text for command.` },
			{ type: "blank" },
	...
	},
	{
		...
		lines: [
			...
			{ type: "out", text: `${E}32m  ✓ ${E}0mDownloaded libluajit-linux-x86-64-gnu.tar.gz ${E}90m(0.45s)${E}0m` },
	...
	},
	{
		...
		lines: [
			...
			{ type: "out", text: `${E}32m  ✓ ${E}0mFetching luarocks manifest ${E}90m(0.33s)${E}0m` },
			{ type: "out", text: `${E}32m  ✓ ${E}0mBuilt busted ${E}90m(8ms)${E}0m` },
			{ type: "out", text: `${E}32m  ✓ ${E}0mBuilt mediator_lua ${E}90m(3ms)${E}0m` },
			{ type: "out", text: `${E}32m  ✓ ${E}0mBuilt dkjson ${E}90m(3ms)${E}0m` },
			{ type: "out", text: `${E}32m  ✓ ${E}0mBuilt penlight ${E}90m(41ms)${E}0m` },
			{ type: "out", text: `${E}32m  ✓ ${E}0mBuilt say ${E}90m(3ms)${E}0m` },
			{ type: "out", text: `${E}32m  ✓ ${E}0mBuilt lua_cliargs ${E}90m(4ms)${E}0m` },
			{ type: "out", text: `${E}32m  ✓ ${E}0mBuilt luassert ${E}90m(6ms)${E}0m` },
			{ type: "out", text: `${E}32m  ✓ ${E}0mDownloading dependencies ${E}90m(0.29s)${E}0m` },
			{ type: "out", text: `${E}32mInstalled tool 'busted' -> ~/.lde/tools/busted${E}0m` },
			{ type: "blank" },
			{ type: "cmd", text: "busted" },
			{ type: "out", text: "+++++" },
			{ type: "blank" },
			{ type: "out", text: "5 successes / 0 failures / 0 errors / 0 pending : 0.000741 seconds" },
		],
	},
];
